            ...
            else if (currentPhase >= phaseDays.Count - 1 && (!fullyGrown || dayOfCurrentPhase <= 0))
            {
                ...
                else
                {
                    if (junimoHarvester == null)
                    {
                        ...
                        if (CropRegrowthFactor.GetCropRegrowthSuccess()) Game1.createObjectDebris(seedIndex, xTile, yTile);
                    }
                    var vector2 = new Vector2(xTile, yTile);
                    if (junimoHarvester == null)
                    {
                    ...
                    else
                    {
                        ...
                        if (CropRegrowthFactor.GetCropRegrowthSuccess()) junimoHarvester1.tryToAddItemToHut(new Object(seedIndex, 1));
                    }
                    if (random.NextDouble() < Game1.player.LuckLevel / 1500.0 + Game1.dailyLuck / 1200.0 + .0001)
                    {
