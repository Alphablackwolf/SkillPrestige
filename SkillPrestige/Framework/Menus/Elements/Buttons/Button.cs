...
namespace SkillPrestige.Framework.Menus.Elements.Buttons
{
    ...
    internal abstract class Button : IInputHandler
    {
        ...
        public Rectangle Bounds
        {
            ...
            {
                _bounds = value;
                ClickableTextureComponent = new ClickableTextureComponent(string.Empty, _bounds, string.Empty, HoverText, ButtonTexture, new Rectangle(0, 0, 0, 0), 1f);
            }
        }
        ...
        protected void DrawTitleText(SpriteBatch spriteBatch, Vector2? locationRelativeToButton = null)
        {
            ...
            {
                Vector2 textSize = TitleTextFont.MeasureString(Text);
                int buttonXCenter = Bounds.X + Bounds.Width / 2;
                int buttonYCenter = Bounds.Y + Bounds.Height / 2;
